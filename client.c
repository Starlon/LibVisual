...
int main (int argc, char **argv)
{
	...
	display_create (display, depth, vidoptions, 480, 380, TRUE);
    ...
    //visual_param_entry_set_string(param, "/home/scott/Work/libvisual/branches/libvisual-avs/testpresets/mesh.pip");
