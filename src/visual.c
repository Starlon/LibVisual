    ...
    for(j = 0; j < param_count; j++) {
        ...
        case VISUAL_PARAM_ENTRY_TYPE_STRING:
            g_object_class_install_property(object_class, j + 1,
                g_param_spec_string(name, name, "Please read actor documentation", 
                    "", G_PARAM_READWRITE));
            break;
        case VISUAL_PARAM_ENTRY_TYPE_INTEGER:
            g_object_class_install_property(object_class, j + 1,
                g_param_spec_int(name, name, "Please read actor documentation", 
                    INT_MIN, INT_MAX, 0, G_PARAM_READWRITE));
            break;
        case VISUAL_PARAM_ENTRY_TYPE_FLOAT:
            g_object_class_install_property(object_class, j + 1,
                g_param_spec_float(name, name, "Please read actor documentation", 
                    FLT_MIN, FLT_MAX, 0.0, G_PARAM_READWRITE));
            break;
        case VISUAL_PARAM_ENTRY_TYPE_DOUBLE:
            g_object_class_install_property(object_class, j + 1,
                g_param_spec_double(name, name, "Please read actor documentation", 
                    DBL_MIN, DBL_MAX, 0.0, G_PARAM_READWRITE));
            break;
